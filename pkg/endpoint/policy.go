...
func (e *Endpoint) updateRealizedState(stats *regenerationStatistics, origDir string, revision uint64, compilationExecuted bool) error {
	...
	e.realizedPolicy.DeniedEgressIdentities = e.desiredPolicy.DeniedEgressIdentities
	e.realizedPolicy.DeniedIngressIdentities = e.desiredPolicy.DeniedIngressIdentities
